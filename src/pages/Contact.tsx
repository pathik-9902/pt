...
export default function Contact() {
  ...
  function Avatar({ name }: { name: string }) {
    ...
    return (
      <div className="mx-auto w-32 h-40 rounded-[32px] overflow-hidden bg-black ring-1 ring-white/10 mb-6 flex items-center justify-center shadow-2xl group-hover:ring-[#1877F2]/40 transition-all duration-700">
        {!error ? (
          <img
          ...
          <span className="text-3xl font-black text-[#1877F2] italic uppercase">
            {initials}
          </span>
        )}
      </div>
  ...
  return (
    <div className="relative py-32 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {leaders.map((person, i) => (
            <motion.div
              ...
              className="glass-card rounded-[48px] p-10 text-center hover:border-[#1877F2]/30 transition-all duration-700 group shadow-2xl"
            >
              <Avatar name={person.name} />

              <div className="mb-4">
                <span className="block text-[10px] font-black text-[#1877F2] uppercase tracking-widest mb-1 opacity-60 leading-none">
                  {person.role}
                </span>
              ...
              {person.email && (
                <a
                  ...
                  className="text-[10px] font-bold text-gray-400 hover:text-[#1877F2] transition-colors uppercase tracking-tight block break-all"
                >
                  {person.email}
                </a>
              )}
      ...
      <section className="relative z-10 container mx-auto px-6 mb-40">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="space-y-6 relative z-10 font-medium italic">
              {emails.map((e) => (
                ...
                >
                  <div className="w-14 h-14 rounded-2xl bg-[#1877F2]/10 flex items-center justify-center text-[#1877F2] group-hover:bg-[#1877F2]/20 transition-all">
                    <Mail size={24} />
                  </div>
                  <div>
          ...
          <motion.div
            ...
            className="glass-card rounded-[60px] p-16 border-white/5 relative overflow-hidden"
          >
            <div className="absolute top-0 left-0 w-64 h-64 bg-[#1877F2]/5  pointer-events-none" />
            <h4 className="text-3xl font-black text-white italic uppercase tracking-tighter mb-10">
      ...
      <section className="relative z-10 container mx-auto px-6 mb-40">
        ...
        >
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[1px] bg-gradient-to-r from-transparent via-[#1877F2] to-transparent" />
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-4">
                ...
                <input name="name" type="text" required className="w-full rounded-full px-8 py-5 bg-white/5 border border-white/10 text-white placeholder-white/20 focus:border-[#1877F2] outline-none transition-all font-medium italic" placeholder="Enter name" />
              </div>
              <div className="space-y-4">
                <label className="text-[10px] font-black uppercase tracking-widest text-[#1877F2] pl-6">Email Address</label>
                <input name="email" type="email" required className="w-full rounded-full px-8 py-5 bg-white/5 border border-white/10 text-white placeholder-white/20 focus:border-[#1877F2] outline-none transition-all font-medium italic" placeholder="email@address.com" />
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-4">
                <label className="text-[10px] font-black uppercase tracking-widest text-[#1877F2] pl-6">Phone Number</label>
                <input name="phone" type="tel" required className="w-full rounded-full px-8 py-5 bg-white/5 border border-white/10 text-white placeholder-white/20 focus:border-[#1877F2] outline-none transition-all font-medium italic" placeholder="+91" />
              </div>
              <div className="space-y-4">
                <label className="text-[10px] font-black uppercase tracking-widest text-[#1877F2] pl-6">Subject</label>
                <input name="subject" type="text" required className="w-full rounded-full px-8 py-5 bg-white/5 border border-white/10 text-white placeholder-white/20 focus:border-[#1877F2] outline-none transition-all font-medium italic" placeholder="Project Inquiry" />
              </div>
            </div>

            <div className="space-y-4">
              <label className="text-[10px] font-black uppercase tracking-widest text-[#1877F2] pl-6">Message</label>
              <textarea name="message" rows={6} required className="w-full rounded-[40px] px-8 py-6 bg-white/5 border border-white/10 text-white placeholder-white/20 focus:border-[#1877F2] outline-none transition-all font-medium italic resize-none" placeholder="How can we help?"></textarea>
            </div>
            ...
            <div className="pt-6">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-6 rounded-full bg-[#1877F2] text-white font-black uppercase tracking-[0.3em] shadow-2xl hover:bg-[#1877F2]/80 transition-all flex items-center justify-center gap-4 group"
              >
                Send Transmission
