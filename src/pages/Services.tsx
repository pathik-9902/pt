      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-24">
          {highlights.map((h, i) => (
            <motion.div
              ...
              className="glass-card rounded-[40px] p-10 hover:border-[#39569C]/30 transition-all group"
            >
              <div className="w-14 h-14 rounded-2xl bg-[#39569C]/10 flex items-center justify-center mb-6 border border-[#39569C]/20 group-hover:bg-[#39569C]/20 transition-all">
                <h.icon className="text-[#39569C] w-7 h-7" />
              </div>
              <div className="text-[10px] font-black text-[#39569C]/60 tracking-[0.2em] uppercase mb-2">
                {h.tag}
              </div>
        ...
        <div className="grid xl:grid-cols-12 gap-12 mb-32 items-start">
          <div className="xl:col-span-8">
            <h3 className="text-3xl font-black text-white italic uppercase tracking-tighter mb-10 pl-4 border-l-4 border-[#39569C]">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {sectors.map((s, i) => (
                ...
                >
                  ...
                  <div className="text-[#39569C] text-[10px] font-bold tracking-widest uppercase mb-6 opacity-70">{s.sub}</div>

                  <ul className="space-y-3">
                    {s.items.map((item) => (
                      <li key={item} className="flex gap-3 items-center text-gray-400 text-sm font-medium italic">
                        <div className="w-1.5 h-1.5 rounded-full bg-[#39569C]" />
                        {item}
                      </li>
                    ))}
                  </ul>
          ...
          <div className="xl:col-span-4 lg:sticky lg:top-32">
            <div className="glass-card rounded-[48px] p-12 border-[#39569C]/20 relative overflow-hidden">
               ...
               <h4 className="text-2xl font-black text-white italic uppercase tracking-tighter mb-10">Technical Scope</h4>
                ...
                <div className="space-y-8 relative z-10">
                  ...
                  <div>
                    ...
                    <p className="text-[#39569C] font-bold text-sm tracking-tight">ASTM, AISI, DIN, EN, GOST, GIS</p>
                  </div>
        ...
        <div className="text-center py-20 relative">
          ...
          <Link
            to="/contact"
            className="liquid-button relative z-10 glass-card bg-white text-black px-12 py-6 text-xl font-black uppercase tracking-[0.2em] hover:bg-[#39569C] hover:text-white transition-all shadow-2xl flex items-center justify-center gap-4 max-w-sm mx-auto group"
          >
            Start Project
