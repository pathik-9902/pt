  ...
  return (
    <section className="relative py-32 overflow-hidden">
      <div className="relative z-10 container mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-6 py-2 text-xs font-bold tracking-[0.2em] text-[#1877F2] uppercase backdrop-blur-xl mb-8">
            ...
            >
              ...
              <div className="relative aspect-[16/10] overflow-hidden">
                ...
                <div className="absolute bottom-6 left-8 right-8">
                   <p className="text-[#1877F2] text-[10px] font-black tracking-widest uppercase mb-1">
                    {item.category}
                  </p>
              ...
              <div className="p-8 pb-10 flex flex-col flex-1 relative">
                ...
                <div className="mt-auto pt-6 border-t border-white/5">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {item.materials.split(",").slice(0, 3).map((mat) => (
                      <span
                        key={mat.trim()}
                        className="bg-white/5 border border-white/10 px-3 py-1 rounded-full text-[10px] font-bold text-[#1877F2]/70"
                      >
                        {mat.trim()}
                      </span>
                    ))}
                ...
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#1877F2]/5  rounded-full group-hover:bg-[#1877F2]/10 transition-colors pointer-events-none" />
              </div>
            </motion.article>
          ))}
        </div>
