      ...
      <section className="py-28 relative">
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
          ...
          <motion.div 
            ...
            className="relative"
          >
            <div className="absolute -inset-10 bg-sky-500/5 blur-[100px] rounded-[60px]" />
            <PremiumImage
              src="/assets/team/about.webp"
              alt="about"
              className="rounded-[40px] shadow-[0_40px_120px_rgba(0,0,0,0.6)] border border-white/10 object-cover aspect-square lg:aspect-auto"
            />
          </motion.div>
            ...
            {team.map((m, i) => (
              ...
              >
                ...
                <div className="p-10 text-center relative">
                  ...
                  <p className="text-[#007AFF] font-medium text-sm mb-6 uppercase tracking-widest">{m.role}</p>
                  ...
                  {m.linkedin && (
                    <a
                      ...
                      className="inline-flex items-center text-white/50 hover:text-[#007AFF] transition-colors text-sm font-medium"
                    >
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <div className="relative">
            ...
            <motion.div
              ...
              className="hidden md:block absolute left-1/2 -translate-x-1/2 top-0 w-[1px] bg-gradient-to-b from-[#007AFF] via-[#007AFF]/50 to-transparent origin-top shadow-[0_0_15px_rgba(0,122,255,0.5)]"
            />
              ...
              {milestones.map((m, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Dot */}
                    <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 w-3 h-3 bg-white rounded-full z-10 shadow-[0_0_20px_rgba(255,255,255,0.8)] border-4 border-black" />
                    ...
                    <div className={`w-full md:w-1/2 ${isEven ? 'md:pl-16' : 'md:pr-16'}`}>
                      <div className="glass-card p-8 rounded-[30px] border border-white/5 hover:border-sky-500/20 transition-colors shadow-2xl">
                        <div className="inline-block px-3 py-1 rounded-full bg-[#007AFF]/10 text-[#007AFF] text-[10px] font-bold tracking-[0.2em] mb-4 uppercase">
                          {m.year}
                        </div>
