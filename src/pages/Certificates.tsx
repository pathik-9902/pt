          ...
          {CERTS.map((c, i) => {
            ...
            return (
              <motion.article
                ...
                className="group relative rounded-[48px] overflow-hidden glass-card shadow-2xl cursor-pointer p-6 border-white/5 hover:border-[#007AFF]/30 transition-all duration-500"
                onClick={() => openCert(c)}
              >
                <div className="relative aspect-[210/297] rounded-[32px] overflow-hidden bg-black mb-8 ring-1 ring-white/5 shadow-inner">
                  {embedUrl ? (
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-4">
                      <div className="w-20 h-20 rounded-3xl bg-white/5 border border-white/10 flex items-center justify-center text-[#007AFF] group-hover:bg-[#007AFF]/20 transition-all">
                ...
                <div className="px-4 text-center">
                  <span className="block text-[10px] font-black text-[#007AFF]/60 tracking-widest uppercase mb-1">Certe-ID: PAD-{c.id}</span>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6 md:p-12">
          ...
          <motion.div
            ...
            className="relative rounded-[56px] overflow-hidden glass-card bg-black/60 shadow-[0_0_100px_rgba(0,122,255,0.1)] border-white/10 w-full max-w-5xl overflow-y-auto max-h-full"
          >
            {/* HEADER */}
            <div
              data-modal-header
            ...
            >
              <div>
                ...
                <p className="text-xs font-bold text-[#007AFF]/60 uppercase tracking-widest leading-none">
              ...
              <div className="flex items-center gap-4">
                {activeOriginalUrl && (
                  <a
                    ...
                    className="w-14 h-14 rounded-full glass-card flex items-center justify-center text-white hover:bg-[#007AFF] hover:text-white transition-all shadow-xl"
                  >
                    <Download size={20} />
                  </a>
                )}
