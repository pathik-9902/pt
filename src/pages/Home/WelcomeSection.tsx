    ...
    <section className="relative py-32 overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-5xl mx-auto text-center mb-24">
          ...
          >
            <div className="glass-card px-6 py-2 rounded-full border border-[#7FA1C3]/20 text-xs font-black tracking-widest text-[#7FA1C3] uppercase">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="h-px w-24 bg-[#7FA1C3] mx-auto" />
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-12">
                ...
                return (
                  <button
                    ...
                    className={`flex-1 min-w-[120px] px-8 py-4 rounded-full text-sm font-black uppercase tracking-widest transition-all duration-500 ${
                      active ? "bg-[#7FA1C3] text-white shadow-lg shadow-[#7FA1C3]/40" : "text-gray-500 hover:text-white"
                    }`}
                  >
                    {tabs[tabKey].title}
                  </button>
            ...
            >
              <div className="glass-card p-12 rounded-[48px] border-[#7FA1C3]/10 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-64 h-64 bg-[#7FA1C3]/5 rounded-full pointer-events-none" />
                <h3 className="text-3xl font-black text-white italic uppercase tracking-tighter mb-6 flex items-center gap-4">
                  <div className="w-12 h-12 bg-[#7FA1C3] rounded-2xl flex items-center justify-center">
                    {(() => {
                ...
                <div className="h-1 w-20 bg-[#7FA1C3]" />
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {tabs[activeTab].features.map((f, i) => (
                  <motion.div
                    ...
                    className="glass-card p-8 rounded-[40px] hover:border-[#7FA1C3]/30 transition-all group"
                  >
                    <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-6 group-hover:bg-[#7FA1C3]/20 group-hover:border-[#7FA1C3]/40 transition-all">
                      <f.icon className="w-6 h-6 text-[#7FA1C3]" />
                    </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10">
                {aims.map((aim, i) => (
                  <div key={i} className="flex gap-6 items-start p-6 rounded-[32px] hover:bg-white/5 transition-colors border border-transparent hover:border-white/10">
                    <div className="w-10 h-10 rounded-full bg-[#7FA1C3] flex items-center justify-center text-white font-black shrink-0">
                      {i + 1}
                    </div>
