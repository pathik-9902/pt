    ...
    <section className="relative py-32 overflow-hidden">
      <div className="relative z-10 container mx-auto px-6">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute left-1/2 top-0 h-full w-[1px] -translate-x-1/2 bg-gradient-to-b from-[#7FA1C3] via-[#7FA1C3]/50 to-transparent shadow-[0_0_15px_rgba(255,255,255,0.3)]" />
                ...
                >
                    ...
                    <div className="relative aspect-video">
                      ...
                      <div className="absolute top-6 left-6">
                        <div className="flex items-center gap-4 bg-black/60 border border-white/20 px-6 py-3 rounded-full backdrop-blur-xl">
                          <div className="text-[#7FA1C3] text-2xl h-10 w-10 flex items-center justify-center bg-white/5 rounded-xl">
                            {step.icon}
                          </div>
                          <div>
                            <span className="block text-[8px] font-black uppercase tracking-[0.3em] text-[#7FA1C3] opacity-60">Step {step.id}</span>
                  ...
                  >
                    ...
                    <div className="lg:hidden flex items-center gap-4 mb-8">
                       <div className="text-[#7FA1C3] text-xl h-10 w-10 flex items-center justify-center bg-white/5 rounded-xl">
                         {step.icon}
                       </div>
                    ...
                    <div className="mt-8 pt-8 border-t border-white/5 flex items-center justify-between opacity-40">
                       ...
                       <div className="w-2 h-2 rounded-full bg-[#7FA1C3]" />
                    </div>
                  </motion.div>
                </motion.article>
              );
